...
/**
 * Persona selector — "Viewing as: <persona>".
 *
 * Shows ONLY personas returned by the authorization provider (the seam where
 * real roles will later restrict the list). Switching preserves the active
 * asset thread, updates navigation/landing immediately, and shows a brief
 * confirmation. Unrestricted switching is clearly labelled as a demo capability.
 * This is a view selection, not authentication.
 */
export function PersonaSelector() {
  ...
  function choose(id: PersonaId) {
    ...
    router.push(personaLandingRoute(id, { assetTag }));
  }
